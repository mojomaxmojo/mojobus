...
# ============================================
# MojoBus VPS TEST Deploy Script (pnpm)
...
# Beispiel: DEPLOY_COMMIT_HASH=6647829 ./deploy-pnpm.sh --force
# ============================================
...
LOG_FILE="$LOG_DIR/deploy-pnpm-$(date +%Y%m%d-%H%M%S).log"
LATEST_LOG="$LOG_DIR/deploy-pnpm-latest.log"
...
main() {
    echo ""
    echo "=========================================="
    echo "🧪 MojoBus VPS TEST Deploy (pnpm)"
    echo "=========================================="
    echo ""
