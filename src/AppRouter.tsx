...
// const MapPage = lazy(() => import("./pages/MapPage").then(m => ({ default: m.default }))); // Temporarily disabled due to build issues
        ...
        <main className="flex-1">
          <Suspense fallback={<PageLoader text="Seite wird geladen..." />}>
            <Routes>
              ...
              {/* <Route path="/map" element={<MapPage />} /> */}  {/* Temporarily disabled due to build issues */}
