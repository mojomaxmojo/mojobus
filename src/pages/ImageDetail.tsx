   ...
   return (
     <div className="min-h-screen py-8">
       <div className="container mx-auto px-4 max-w-4xl">
         ...
         {/* Author Section - Above Image */}
         <div className="flex items-center gap-3 mb-6">
           {metadata?.picture ? (
             <div className="w-10 h-10 flex-shrink-0 relative overflow-hidden rounded-full bg-gray-200 dark:bg-gray-700 shadow-md">
               <img
             ...
             <div className="w-10 h-10 flex-shrink-0 rounded-full bg-gray-200 dark:bg-gray-700 flex items-center justify-center shadow-md">
               <User className="h-5 w-5 text-gray-500" />
             </div>
           )}
           <div className="flex-1">
             <h3 className="font-semibold text-lg">{metadata?.name || 'Anonymous'}</h3>
           ...
           <CardContent className="p-0 bg-white">
             ...
             >
               <img
                 ...
                 alt="Reisebild"
                 className="w-full object-contain bg-white max-h-[80vh]"
                 loading="eager"
                 decoding="sync"
               />
               ...
               <div className="absolute inset-0 bg-black/20 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                 <div className="bg-white/95 rounded-lg p-4 flex flex-col items-center gap-2 shadow-xl">
